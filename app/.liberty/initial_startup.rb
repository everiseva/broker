...
def get_environment(app_dir)
  env = {}
  env['PATH'] = "#{ENV['PATH']}:#{app_dir}/.app-management/node/bin"
  env['BLUEMIX_DEV_CONSOLE_HIDE'] = '["suspend"]'
  env['BLUEMIX_DEV_CONSOLE_START_TIMEOUT'] = '30000'
